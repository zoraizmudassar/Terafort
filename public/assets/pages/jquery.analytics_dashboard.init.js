...
//Device-widget
var noAction = document.getElementById('noAction').innerHTML;
var Process = document.getElementById('Process').innerHTML;
var final = document.getElementById('final').innerHTML;
var complete = document.getElementById('complete').innerHTML;
var total = document.getElementById('total').innerHTML;
var completeVal = complete/total*100;
var noActionVal = noAction/total*100;
var ProcessVal = Process/total*100;
var finalVal = final/total*100;
const Valcomplete = String(completeVal).slice(0, 4); 
const completeValue = Number(Valcomplete);
const ValnoAction = String(noActionVal).slice(0, 4);
const noActionValue = Number(ValnoAction);
const ValProcess = String(ProcessVal).slice(0, 4);
const ProcessValue = Number(ValProcess);
const ValFinal = String(finalVal).slice(0, 4);
const FinalValue = Number(ValFinal);
...
var options = {
  ...
  series: [noActionValue,FinalValue,ProcessValue,completeValue],
  legend: {
      show: true,
      position: 'bottom',
  ...
  labels: [ "No Action","Closed","In Process","Complete"],
  colors: ['#f14b4b','#0dc8de','#ffb822','#1eca7b'],
