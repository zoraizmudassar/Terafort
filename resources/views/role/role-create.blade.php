					    ...
					    <div class="p-5">
						    <div class="form-group row py-2">
                                <div class="col-sm-3 mb-1 mb-sm-0">
								    ...
								    <button type="submit" class="btn w-100 py-1 text-white mt-4" style="border: none; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)); border: none; font-size: 15px;">Create</button>
                                </div>
                                <div class="col-sm-9">
