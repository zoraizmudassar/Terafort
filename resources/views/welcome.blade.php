                    ...
                    <form action="{{ route('SignIn') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <label for="example-input1-group1" style="letter-spacing: 0.3px;"><b style="font-weight: 500;">Login with Email or Username</b></label>
                                <div class="input-group">
                                    <input id="email" name="email" value="{{ old('email') }}" type="text" name="example-input1-group1" class="form-control py-2" placeholder="Username">
                                </div>
                            </div>
                            <div class="col-md-2">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <label for="example-input1-group1" style="letter-spacing: 0.3px;"><b style="font-weight: 500;">Password</b></label>
                                <div class="input-group">
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror py-2" placeholder="Password" name="password" required autocomplete="current-password">
                                </div>
                            </div>
                            <div class="col-md-2">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <button type="submit" style="background: linear-gradient(14deg, #fc5c04 0%, #f96c07);" class="btn px-5 py-2 btn-lg btn-block text-white border-0">Login</button>
                            </div>
                            <div class="col-md-2">
                            </div>
                        </div>
